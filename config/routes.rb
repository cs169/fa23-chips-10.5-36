...
Rails.application.routes.draw do
    ...
    get '/state/:state_symbol/county/:std_fips_code/:address' => 'search#search'
    ...
    get '/campaign_finances/search/(:search)' => 'campaign_finances#search', :as => 'search_campaign_finances'
